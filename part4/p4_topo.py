...
# This version creates a network of OpenFlow switches.
...
def build():
    ...
    # The network topology from the assignment diagram.
    # NOTE: The diagram shows s2-s4 and s3-s5 links, not s2-s3 or s4-s1.
    # The provided OSPF topo script had a different wiring. This one matches the diagram.
    net.addLink(s1, s2, intfName1='s1-eth2', intfName2='s2-eth1', bw=10) # Cost 10
    net.addLink(s1, s3, intfName1='s1-eth3', intfName2='s3-eth1', bw=10) # Cost 10
    
    net.addLink(s2, s4, intfName1='s2-eth2', intfName2='s4-eth1', bw=20) # Cost 20
    net.addLink(s3, s5, intfName1='s3-eth2', intfName2='s5-eth1', bw=20) # Cost 20
    
    net.addLink(s4, s6, intfName1='s4-eth2', intfName2='s6-eth1', bw=10) # Cost 10
    net.addLink(s5, s6, intfName1='s5-eth2', intfName2='s6-eth2', bw=10) # Cost 10
