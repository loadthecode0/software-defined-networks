...
#     s1 = net.addSwitch('s1', cls=OVSSwitch, dpid=hex_dpid(1), failMode='secure')
#     s2 = net.addSwitch('s2', cls=OVSSwitch, dpid=hex_dpid(2), failMode='secure')
#     s3 = net.addSwitch('s3', cls=OVSSwitch, dpid=hex_dpid(3), failMode='secure')
#     s4 = net.addSwitch('s4', cls=OVSSwitch, dpid=hex_dpid(4), failMode='secure')
#     s5 = net.addSwitch('s5', cls=OVSSwitch, dpid=hex_dpid(5), failMode='secure')
#     s6 = net.addSwitch('s6', cls=OVSSwitch, dpid=hex_dpid(6), failMode='secure')
